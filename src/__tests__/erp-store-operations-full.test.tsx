...
describe('1. Store CRUD Completo (14+ entidades)', () => {
  ...
  makeEntityTests('CotizacionCliente', { tipo: 'construccion', numero: 'COT-001', fecha: '2026-01-01', clienteNombre: 'Cliente', descripcion: 'Test', alcance: 'Alcance', renglones: [], costoDirectoTotal: 0, precioVentaTotal: 0, estado: 'borrador', createdAt: '2026-01-01T00:00:00Z', updatedAt: '2026-01-01T00:00:00Z' });
