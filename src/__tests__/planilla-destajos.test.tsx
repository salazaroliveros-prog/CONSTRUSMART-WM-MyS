...
vi.mock('react-i18next', () => {
  const translations: Record<string, string> = {
    ...
    'planilla.titulo': 'Planilla de Destajos',
    'planilla_destajos.pago_semanal': 'Pago Semanal',
    'planilla_destajos.nuevo_destajo': 'Nuevo Destajo',
    'planilla_destajos.cuadrillas': 'Cuadrillas',
    'planilla_destajos.destajos': 'Destajos',
    'planilla_destajos.total_a_pagar': 'Total a Pagar',
    'planilla_destajos.promedio_cuadrilla': 'Promedio/Cuadrilla',
    'planilla_destajos.cuadrilla': 'Cuadrilla',
    'planilla_destajos.total_ejecutado': 'Total Ejecutado',
    ...
    'planilla_destajos.proyecto': 'Proyecto',
    'planilla_destajos.cantidad': 'Cantidad',
    'planilla_destajos.accion': 'Acción',
    'planilla_destajos.eliminar': 'Eliminar',
    'planilla_destajos.eliminar_destajo_aria': 'Eliminar destajo de {{cuadrilla}}',
    'planilla_destajos.exportar_csv': 'Exportar CSV',
    'planilla_destajos.guardar_destajo': 'Guardar Destajo',
    'planilla_destajos.cancelar': 'Cancelar',
    'common.si': 'Sí',
