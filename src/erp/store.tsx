...
export const ErpProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
  ...
  const value = useMemo(() => ({
    ...
    eventos: [] as EventoCalendario[], addEvento: async () => {}, updateEvento: async () => {}, deleteEvento: async () => {},
    bitacora: [] as BitacoraEntry[], addBitacora: async () => {}, updateBitacora: async () => {}, deleteBitacora: async () => {},
    ...
    seguimientoEVM: [] as SeguimientoEVM[],
    addSeguimiento: async () => {}, updateSeguimiento: async () => {}, deleteSeguimiento: async () => {},
    avanceFinancieroCalculado: () => 0,
    valesSalida: [] as ValeSalida[], addValeSalida: async () => {}, deleteValeSalida: async () => {},
    cuentasCobrar: [] as CuentaCobrar[], addCuentaCobrar: async () => {}, updateCuentaCobrar: async () => {}, deleteCuentaCobrar: async () => {},
    cuentasPagar: [] as CuentaPagar[], addCuentaPagar: async () => {}, updateCuentaPagar: async () => {}, deleteCuentaPagar: async () => {},
    ordenesCambio: [] as OrdenCambio[], addOrdenCambio: async () => {}, updateOrdenCambio: async () => {}, deleteOrdenCambio: async () => {},
    hitos: [] as Hito[], addHito: async () => {}, updateHito: async () => {}, deleteHito: async () => {},
    riesgos: [] as Riesgo[], addRiesgo: async () => {}, updateRiesgo: async () => {}, deleteRiesgo: async () => {},
    planos: [] as Plano[], addPlano: async () => {}, updatePlano: async () => {},
    rfis: [] as RFI[], addRfi: async () => {}, updateRfi: async () => {},
    submittals: [] as Submittal[], addSubmittal: async () => {}, updateSubmittal: async () => {},
    activos: [] as ActivoHerramienta[], addActivo: async () => {}, updateActivo: async () => {}, deleteActivo: async () => {},
    cuadros: [] as CuadroComparativo[], addCuadro: async () => {}, updateCuadro: async () => {},
    pagosProveedor: [] as PagoProveedor[], addPagoProveedor: async () => {}, updatePagoProveedor: async () => {},
    incidentes: [], addIncidente: async () => {}, updateIncidente: async () => {},
    publicacionesMuro: [] as PublicacionMuro[], addPublicacionMuro: async () => {}, addComentarioMuro: async () => {}, likePublicacionMuro: async () => {},
    pruebas: [] as PruebaLaboratorio[], addPrueba: async () => {}, updatePrueba: async () => {},
    ncs: [] as NoConformidad[], addNC: async () => {}, updateNC: async () => {},
    liberaciones: [] as LiberacionPartida[], addLiberacion: async () => {}, updateLiberacion: async () => {},
