...
export type AppThemeMode = 'light' | 'dark' | 'high-contrast' | 'ant-design' | 'dark-pro' | 'material3' | 'glassmorphism' | 'neomorphism' | 'nova-os';
...
const MUTATION_TABLE_MAP: Record<string, string> = {
  ...
  updatePublicacionMuro:'erp_publicaciones_muro',
  deletePublicacionMuro:'erp_publicaciones_muro',
...
useEffect(() => {
  ...
  const subscribeToRealtime = async () => {
    ...
    const subs: string[] = [
      ...
      'erp_publicaciones_muro', 'erp_ventas_paquetes', 'erp_proyecto_weather',
