  ...
  return (
    <header className="bg-slate-900/80 backdrop-blur-md text-white px-4 sm:px-6 py-3 flex items-center justify-between gap-3 sticky top-0 z-30 shadow-lg">
      <div className="flex items-center gap-3 min-w-0">
        {onMenu && (
          <button
            ...
            className="lg:hidden p-1.5 hover:bg-white/10 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
          >
      ...
      <div className="flex items-center gap-2">
        ...
        <div className="flex items-center gap-2">
          <button onClick={onPick} className="relative focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring rounded-full" title="Cambiar foto de perfil" aria-label="Cambiar foto de perfil">
            {avatarSrc ? (
        ...
        <button onClick={logout} title="Cerrar sesión" aria-label="Cerrar sesión" className="p-2 hover:bg-red-500/20 text-red-300 rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-400">
