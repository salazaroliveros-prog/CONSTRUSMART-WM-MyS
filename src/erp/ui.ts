...
export const INPUT = 'w-full px-3.5 py-2.5 rounded-xl text-sm outline-none focus:ring-2 focus:ring-orange-100 transition-all';
export const INPUT_COMPACT = 'w-full px-2.5 py-1.5 text-xs rounded-lg outline-none focus:ring-2 focus:ring-orange-100 transition-all';
export const ERROR_STATE = 'focus:ring-2 focus:ring-red-100';
