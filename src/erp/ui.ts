...
export const MODAL_PANEL = 'bg-card rounded-lg shadow-xl border border-border w-full max-w-lg max-h-[85vh] overflow-y-auto';
export const MODAL_HEADER = 'flex items-center justify-between p-4 border-b border-border';
export const MODAL_TITLE = 'text-lg font-semibold text-foreground';
