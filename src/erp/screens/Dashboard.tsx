...
const CATEGORIA_MAP = [
  ...
  { id: 'ejecucion', label: 'Ejecución', targetView: 'seguimiento', modules: ['Seguimiento', 'Rendimiento Campo', 'SSO', 'Muro', 'Órdenes Cambio', 'Documentos', 'BIM'], tables: ['erp_seguimiento', 'erp_avances', 'erp_rendimientos_cuadrilla', 'erp_no_conformidades', 'erp_publicaciones_muro', 'erp_ordenes_cambio', 'erp_planos', 'erp_rfis', 'erp_submittals'] },
