      ...
      <div className="flex-1 flex items-center justify-center p-6 bg-slate-50">
        <form onSubmit={(e) => { e.preventDefault(); }} className="w-full max-w-sm">
          <div className="lg:hidden flex items-center gap-3 mb-8">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-500 to-amber-500 flex items-center justify-center font-black text-white">
              WM
            </div>
            <div>
          ...
          <p className="text-slate-400 text-sm mb-6">Acceso solo para administrador</p>
