...
<option value="">{t('apu.sin_proyecto')}</option>
            ...
            <div className="bg-orange-50 dark:bg-orange-950/20 border border-orange-100 dark:border-orange-900/50 rounded-xl p-4">
              <div className="flex items-center justify-between flex-wrap gap-2">
                <div><span className="text-xs text-orange-600 dark:text-orange-400 font-medium">{t('apu.total_sobrecosto')}:</span><span className="text-xl font-bold text-orange-700 dark:text-orange-300 ml-2">{factor.indirectos + factor.administracion + factor.imprevistos + factor.utilidad}%</span></div>
                <div><span className="text-xs text-orange-600 dark:text-orange-400 font-medium">{t('apu.factor_multiplicador')}:</span><span className="text-xl font-bold text-orange-700 dark:text-orange-300 ml-2">{((factor.indirectos + factor.administracion + factor.imprevistos + factor.utilidad) / 100 + 1).toFixed(2)}</span></div>
              ...
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    <div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="text-xs text-blue-600 dark:text-blue-400 mb-1">{t('apu.cemento')}</div><div className="text-lg font-bold text-blue-700 dark:text-blue-300">{resultadoDosificacion.cementoSacos.toFixed(1)} sacos</div></div>
                    <div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg p-3 border border-amber-100 dark:border-amber-900/50"><div className="text-xs text-amber-600 dark:text-amber-400 mb-1">{t('apu.arena')}</div><div className="text-lg font-bold text-amber-700 dark:text-amber-300">{resultadoDosificacion.arenaM3.toFixed(2)} m³</div></div>
                    ...
                    <div className="bg-cyan-50 dark:bg-cyan-950/20 rounded-lg p-3 border border-cyan-100 dark:border-cyan-900/50"><div className="text-xs text-cyan-600 dark:text-cyan-400 mb-1">{t('apu.agua')}</div><div className="text-lg font-bold text-cyan-700 dark:text-cyan-300">{resultadoDosificacion.aguaLt.toFixed(0)} lt</div></div>
                  </div>
                </div>
...
<p className="text-xs text-muted-foreground mb-4 truncate" title={t('apu.ejemplo_renglon')}>{t('apu.ejemplo_renglon')}</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              <div className="bg-blue-50 dark:bg-blue-950/20 rounded-xl p-4 border border-blue-100 dark:border-blue-900/50"><div className="flex items-center gap-1.5 mb-1"><Wrench className="w-3.5 h-3.5 text-blue-500" /><span className="text-xs font-medium text-blue-600 dark:text-blue-400">{t('apu.materiales_label')}</span></div><div className="text-xl font-bold text-blue-700 dark:text-blue-300">Q{calculos.cd.materiales.toFixed(2)}</div></div>
              <div className="bg-emerald-50 dark:bg-emerald-950/20 rounded-xl p-4 border border-emerald-100 dark:border-emerald-900/50"><div className="flex items-center gap-1.5 mb-1"><Users className="w-3.5 h-3.5 text-emerald-500" /><span className="text-xs font-medium text-emerald-600 dark:text-emerald-400">{t('apu.mano_obra_label')}</span></div><div className="text-xl font-bold text-emerald-700 dark:text-emerald-300">Q{calculos.cd.manoObra.toFixed(2)}</div></div>
              <div className="bg-purple-50 dark:bg-purple-950/20 rounded-xl p-4 border border-purple-100 dark:border-purple-900/50"><div className="flex items-center gap-1.5 mb-1"><Settings className="w-3.5 h-3.5 text-purple-500" /><span className="text-xs font-medium text-blue-600 dark:text-blue-400">{t('apu.equipo_label')}</span></div><div className="text-xl font-bold text-purple-700 dark:text-purple-300">Q{calculos.cd.equipo.toFixed(2)}</div></div>
            </div>
...
<p className="text-xs text-muted-foreground mb-4 truncate" title={t('apu.historico_descripcion')}>{t('apu.historico_descripcion')}</p>
            {historial.length > 0 ? (<>
              ...
              <div className="mt-3 grid grid-cols-2 sm:grid-cols-4 gap-2">
                <div className="bg-muted/30 rounded-xl p-3 border border-border"><div className="text-xs text-muted-foreground">{t('apu.cemento_resumen')}</div><div className="text-sm font-bold text-orange-600 dark:text-orange-400">Q{historial[historial.length - 1].cemento.toFixed(0)}<span className="text-xs ml-1 text-red-500 dark:text-red-400">↑ {(((historial[historial.length - 1].cemento - historial[0].cemento) / (historial[0].cemento || 1)) * 100).toFixed(1)}%</span></div></div>
                <div className="bg-muted/30 rounded-xl p-3 border border-border"><div className="text-xs text-muted-foreground">{t('apu.hierro_resumen')}</div><div className="text-sm font-bold text-blue-600 dark:text-blue-400">Q{historial[historial.length - 1].hierro.toFixed(0)}<span className="text-xs ml-1 text-red-500 dark:text-red-400">↑ {(((historial[historial.length - 1].hierro - historial[0].hierro) / (historial[0].hierro || 1)) * 100).toFixed(1)}%</span></div></div>
                <div className="bg-muted/30 rounded-xl p-3 border border-border"><div className="text-xs text-muted-foreground">{t('apu.arena_resumen')}</div><div className="text-sm font-bold text-emerald-600 dark:text-emerald-400">Q{historial[historial.length - 1].arena.toFixed(0)}<span className="text-xs ml-1 text-red-500 dark:text-red-400">↑ {(((historial[historial.length - 1].arena - historial[0].arena) / (historial[0].arena || 1)) * 100).toFixed(1)}%</span></div></div>
                <div className="bg-muted/30 rounded-xl p-3 border border-border"><div className="text-xs text-muted-foreground">{t('apu.block_resumen')}</div><div className="text-sm font-bold text-blue-600 dark:text-blue-400">Q{historial[historial.length - 1].block.toFixed(0)}<span className="text-xs ml-1 text-red-500 dark:text-red-400">↑ {(((historial[historial.length - 1].block - historial[0].block) / (historial[0].block || 1)) * 100).toFixed(1)}%</span></div></div>
              </div>
        ...
        {tab === 'acero' && (
          <div className="min-w-0">
            ...
            {resultadoAcero && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.desglose_diametro')}</h3><div className="space-y-2">{(resultadoAcero?.desglose || []).map((item, index: number) => (<div key={index} className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="flex items-center justify-between"><span className="text-xs text-blue-600 dark:text-blue-400">Diámetro {item.diametro}</span><span className="text-lg font-bold text-blue-700 dark:text-blue-300">{item.cantidadKg.toFixed(2)} kg</span></div><div className="text-xs text-muted-foreground mt-1">{t('apu.costo_precio_kg', { costo: item.costoTotal.toFixed(2), precio: item.precioUnitarioKg.toFixed(2) })}</div></div>))}</div></div>
        ...
        {tab === 'movimientoTierra' && (
          <div className="min-w-0">
            ...
            {resultadoMovimientoTierra && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.mov_resultados')}</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="text-xs text-blue-600 dark:text-blue-400 mb-1">{t('apu.mov_costo_unitario')}</div><div className="text-lg font-bold text-blue-700 dark:text-blue-300">Q{resultadoMovimientoTierra.costoUnitario?.toFixed(2) || '0.00'}/m³</div></div><div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg p-3 border border-amber-100 dark:border-amber-900/50"><div className="text-xs text-amber-600 dark:text-amber-400 mb-1">{t('apu.mov_costo_total')}</div><div className="text-lg font-bold text-amber-700 dark:text-amber-300">Q{resultadoMovimientoTierra.costoTotal?.toFixed(2) || '0.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.mov_tiempo_estimado')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">{resultadoMovimientoTierra.tiempoEstimadoDias?.toFixed(1) || '0'} días</div></div><div className="bg-cyan-50 dark:bg-cyan-950/20 rounded-lg p-3 border border-cyan-100 dark:border-cyan-900/50"><div className="text-xs text-cyan-600 dark:text-cyan-400 mb-1">{t('apu.mov_factor_ajuste')}</div><div className="text-lg font-bold text-cyan-700 dark:text-cyan-300">{resultadoMovimientoTierra.factorAjusteTotal?.toFixed(2) || '1.00'}</div></div></div></div>
...
<p className="text-xs text-muted-foreground mb-4 truncate" title={t('apu.climaticos_descripcion')}>{t('apu.climaticos_descripcion')}</p>
            ...
            {resultadoClimaticos && (
              <div className="mt-4 space-y-3">
                 <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3 truncate" title={t('apu.climaticos_factores_titulo')}>{t('apu.climaticos_factores_titulo')}</h3><div className="grid grid-cols-1 sm:grid-cols-3 gap-3"><div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="text-xs text-blue-600 dark:text-blue-400 mb-1">{t('apu.climaticos_factor_curado')}</div><div className="text-lg font-bold text-blue-700 dark:text-blue-300">{resultadoClimaticos.factorCurado?.toFixed(2) || '1.00'}</div></div><div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg p-3 border border-amber-100 dark:border-amber-900/50"><div className="text-xs text-amber-600 dark:text-amber-400 mb-1">{t('apu.climaticos_factor_rendimiento')}</div><div className="text-lg font-bold text-amber-700 dark:text-amber-300">{resultadoClimaticos.factorRendimiento?.toFixed(2) || '1.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.climaticos_factor_proteccion')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">{resultadoClimaticos.factorProteccion?.toFixed(2) || '1.00'}</div></div></div></div>
        ...
        {tab === 'pavimentos' && (
          <div className="min-w-0">
            ...
            {resultadoPavimento && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.pav_resultados')}</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="text-xs text-blue-600 dark:text-blue-400 mb-1">{t('apu.pav_espesor')}</div><div className="text-lg font-bold text-blue-700 dark:text-blue-300">{resultadoPavimento.espesorCm?.toFixed(1) || '0'} cm</div></div><div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg p-3 border border-amber-100 dark:border-amber-900/50"><div className="text-xs text-amber-600 dark:text-amber-400 mb-1">{t('apu.pav_costo_total_m2')}</div><div className="text-lg font-bold text-amber-700 dark:text-amber-300">Q{resultadoPavimento.costoTotalM2?.toFixed(2) || '0.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.pav_costo_total')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">Q{resultadoPavimento.costoTotal?.toFixed(2) || '0.00'}</div></div><div className="bg-cyan-50 dark:bg-cyan-950/20 rounded-lg p-3 border border-cyan-100 dark:border-cyan-900/50"><div className="text-xs text-cyan-600 dark:text-cyan-400 mb-1">{t('apu.pav_volumen_base')}</div><div className="text-lg font-bold text-cyan-700 dark:text-cyan-300">{resultadoPavimento.volumenBaseM3?.toFixed(2) || '0'} m³</div></div></div></div>
        ...
        {tab === 'redesInfraestructura' && (
          <div className="min-w-0">
            ...
            {resultadoRedInfraestructura && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.redes_resultados')}</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="text-xs text-blue-600 dark:text-blue-400 mb-1">{t('apu.redes_costo_unitario')}</div><div className="text-lg font-bold text-blue-700 dark:text-blue-300">Q{resultadoRedInfraestructura.costoUnitarioMl?.toFixed(2) || '0.00'}/ml</div></div><div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg p-3 border border-amber-100 dark:border-amber-900/50"><div className="text-xs text-amber-600 dark:text-amber-400 mb-1">{t('apu.redes_costo_total')}</div><div className="text-lg font-bold text-amber-700 dark:text-amber-300">Q{resultadoRedInfraestructura.costoTotal?.toFixed(2) || '0.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.redes_factor_material')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">{resultadoRedInfraestructura.factorAjusteMaterial?.toFixed(2) || '1.00'}</div></div><div className="bg-cyan-50 dark:bg-cyan-950/20 rounded-lg p-3 border border-cyan-100 dark:border-cyan-900/50"><div className="text-xs text-cyan-600 dark:text-cyan-400 mb-1">{t('apu.redes_normativa')}</div><div className="text-sm font-bold text-cyan-700 dark:text-cyan-300">{resultadoRedInfraestructura.referenciaNorma || ''}</div></div></div></div>
        ...
        {tab === 'murosContencion' && (
          <div className="min-w-0">
            ...
            {resultadoMuroContencion && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.muros_resultados')}</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><div className="bg-blue-50 dark:bg-blue-950/20 rounded-lg p-3 border border-blue-100 dark:border-blue-900/50"><div className="text-xs text-blue-600 dark:text-blue-400 mb-1">{t('apu.muros_costo_unitario')}</div><div className="text-lg font-bold text-blue-700 dark:text-blue-300">Q{resultadoMuroContencion.costoUnitarioM2?.toFixed(2) || '0.00'}/m²</div></div><div className="bg-amber-50 dark:bg-amber-950/20 rounded-lg p-3 border border-amber-100 dark:border-amber-900/50"><div className="text-xs text-amber-600 dark:text-amber-400 mb-1">{t('apu.muros_costo_total')}</div><div className="text-lg font-bold text-amber-700 dark:text-amber-300">Q{resultadoMuroContencion.costoTotal?.toFixed(2) || '0.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.muros_factor_ajuste')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">{resultadoMuroContencion.factorAjusteTotal?.toFixed(2) || '1.00'}</div></div><div className="bg-cyan-50 dark:bg-cyan-950/20 rounded-lg p-3 border border-cyan-100 dark:border-cyan-900/50"><div className="text-xs text-cyan-600 dark:text-cyan-400 mb-1">{t('apu.muros_volumen_concreto')}</div><div className="text-lg font-bold text-cyan-700 dark:text-cyan-300">{resultadoMuroContencion.volumenConcretoM3?.toFixed(2) || '0'} m³</div></div></div></div>
