              ...
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div className="bg-stone-50 rounded-lg p-3 border border-stone-100"><div className="text-xs text-stone-600 mb-1">{t('apu.piedra')}</div><div className="text-lg font-bold text-stone-700">{resultadoDosificacion.piedraM3.toFixed(2)} m³</div></div>
