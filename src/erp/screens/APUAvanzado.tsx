              ...
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border">
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                    ...
                    <div className="bg-cyan-50 rounded-lg p-3 border border-cyan-100"><div className="text-xs text-cyan-600 mb-1">{t('apu.agua')}</div><div className="text-lg font-bold text-cyan-700">{resultadoDosificacion.aguaLt.toFixed(0)} lt</div></div>
                  </div>
                </div>
...
<p className="text-xs text-muted-foreground mb-4 truncate" title={t('apu.ejemplo_renglon')}>{t('apu.ejemplo_renglon')}</p>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 mb-4">
              ...
              <div className="bg-purple-50 rounded-xl p-4 border border-purple-100"><div className="flex items-center gap-1.5 mb-1"><Settings className="w-3.5 h-3.5 text-purple-500" /><span className="text-xs font-medium text-blue-600">{t('apu.equipo_label')}</span></div><div className="text-xl font-bold text-purple-700">Q{calculos.cd.equipo.toFixed(2)}</div></div>
            </div>
        ...
        {tab === 'movimientoTierra' && (
          <div>
            ...
            {resultadoMovimientoTierra && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.mov_resultados')}</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><div className="bg-blue-50 rounded-lg p-3 border border-blue-100"><div className="text-xs text-blue-600 mb-1">{t('apu.mov_costo_unitario')}</div><div className="text-lg font-bold text-blue-700">Q{resultadoMovimientoTierra.costoUnitario?.toFixed(2) || '0.00'}/m³</div></div><div className="bg-amber-50 rounded-lg p-3 border border-amber-100"><div className="text-xs text-amber-600 mb-1">{t('apu.mov_costo_total')}</div><div className="text-lg font-bold text-amber-700">Q{resultadoMovimientoTierra.costoTotal?.toFixed(2) || '0.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.mov_tiempo_estimado')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">{resultadoMovimientoTierra.tiempoEstimadoDias?.toFixed(1) || '0'} días</div></div><div className="bg-cyan-50 rounded-lg p-3 border border-cyan-100"><div className="text-xs text-cyan-600 mb-1">{t('apu.mov_factor_ajuste')}</div><div className="text-lg font-bold text-cyan-700">{resultadoMovimientoTierra.factorAjusteTotal?.toFixed(2) || '1.00'}</div></div></div></div>
        ...
        {tab === 'murosContencion' && (
          <div>
            ...
            {resultadoMuroContencion && (
              <div className="mt-4 space-y-3">
                <div className="bg-muted/30 rounded-xl p-4 border border-border"><h3 className="font-bold text-muted-foreground text-xs mb-3">{t('apu.muros_resultados')}</h3><div className="grid grid-cols-2 sm:grid-cols-4 gap-3"><div className="bg-blue-50 rounded-lg p-3 border border-blue-100"><div className="text-xs text-blue-600 mb-1">{t('apu.muros_costo_unitario')}</div><div className="text-lg font-bold text-blue-700">Q{resultadoMuroContencion.costoUnitarioM2?.toFixed(2) || '0.00'}/m²</div></div><div className="bg-amber-50 rounded-lg p-3 border border-amber-100"><div className="text-xs text-amber-600 mb-1">{t('apu.muros_costo_total')}</div><div className="text-lg font-bold text-amber-700">Q{resultadoMuroContencion.costoTotal?.toFixed(2) || '0.00'}</div></div><div className="bg-stone-50 dark:bg-stone-800/50 rounded-lg p-3 border border-stone-100 dark:border-stone-700"><div className="text-xs text-stone-600 dark:text-stone-400 mb-1">{t('apu.muros_factor_ajuste')}</div><div className="text-lg font-bold text-stone-700 dark:text-stone-300">{resultadoMuroContencion.factorAjusteTotal?.toFixed(2) || '1.00'}</div></div><div className="bg-cyan-50 rounded-lg p-3 border border-cyan-100"><div className="text-xs text-cyan-600 mb-1">{t('apu.muros_volumen_concreto')}</div><div className="text-lg font-bold text-cyan-700">{resultadoMuroContencion.volumenConcretoM3?.toFixed(2) || '0'} m³</div></div></div></div>
