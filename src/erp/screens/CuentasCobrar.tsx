...
const CuentasCobrar: React.FC = () => {
  ...
  return (
    <div className="p-4 sm:p-6 max-w-[1600px] mx-auto space-y-4">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center animate-in fade-in duration-200" role="dialog" aria-modal="true" aria-label={editingId ? t('cuentas_cobrar.editar') : t('cuentas_cobrar.nueva_cuenta')}>
