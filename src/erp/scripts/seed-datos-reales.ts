...
await upsert('erp_hitos', [
  { id: '61000000-0000-0000-0000-000000000001', proyecto_id: 'a2000000-0000-0000-0000-000000000001', nombre: 'Inicio de obra', descripcion: 'Acta de inicio y movilización', fecha: d(-150), tipo: 'inicio', estado: 'completado', responsable: 'Ing. Luis Hernández', depends_on: '[]', completado_en: `${d(-150)}T00:00:00Z` },
  { id: '61000000-0000-0000-0000-000000000002', proyecto_id: 'a2000000-0000-0000-0000-000000000001', nombre: 'Cimentación completada', fecha: d(-40), tipo: 'hito', estado: 'retrasado', responsable: 'Ing. Patricia Vásquez', depends_on: '["61000000-0000-0000-0000-000000000001"]' },
  { id: '61000000-0000-0000-0000-000000000003', proyecto_id: 'a2000000-0000-0000-0000-000000000002', nombre: 'Terracerías lote 1', fecha: d(-30), tipo: 'hito', estado: 'pendiente', responsable: 'Ing. Mario Paredes', depends_on: '[]' },
  { id: '61000000-0000-0000-0000-000000000004', proyecto_id: 'a2000000-0000-0000-0000-000000000004', nombre: 'Entrega nivel 3', fecha: d(20), tipo: 'entrega', estado: 'pendiente', responsable: 'Ing. Mauricio Samayoa', depends_on: '[]' },
]);
