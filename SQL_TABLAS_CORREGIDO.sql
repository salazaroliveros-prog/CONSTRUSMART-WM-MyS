-- ============================================================
-- TABLAS FALTANTES - ERP CONSTRUSMART (CORREGIDO)
-- Fecha: 2026-06-07
...
CREATE INDEX IF NOT EXISTS idx_renglones_proyecto_id ON erp_renglones(proyecto_id);
CREATE INDEX IF NOT EXISTS idx_renglones_created_by ON erp_renglones(created_by);
CREATE INDEX IF NOT EXISTS idx_insumos_renglon_id ON erp_insumos(renglon_id);
CREATE INDEX IF NOT EXISTS idx_insumos_created_by ON erp_insumos(created_by);
CREATE INDEX IF NOT EXISTS idx_sub_renglones_renglon_id ON erp_sub_renglones(renglon_id);
CREATE INDEX IF NOT EXISTS idx_sub_renglones_created_by ON erp_sub_renglones(created_by);
...
DROP POLICY IF EXISTS "Usuarios autenticados pueden leer renglones" ON erp_renglones;
CREATE POLICY "Usuarios autenticados pueden leer renglones" ON erp_renglones
  FOR SELECT TO authenticated USING (true);

DROP POLICY IF EXISTS "Usuario puede insertar renglones" ON erp_renglones;
CREATE POLICY "Usuario puede insertar renglones" ON erp_renglones
  FOR INSERT TO authenticated WITH CHECK (auth.uid() IS NOT NULL);

DROP POLICY IF EXISTS "Usuario creador o admin puede modificar renglon" ON erp_renglones;
...
DROP POLICY IF EXISTS "Usuario puede eliminar renglones" ON erp_renglones;
CREATE POLICY "Usuario puede eliminar renglones" ON erp_renglones
  FOR DELETE TO authenticated
  USING (created_by = auth.uid() OR auth.jwt() ->> 'rol' = 'Administrador');

-- erp_insumos - Políticas
DROP POLICY IF EXISTS "Usuarios autenticados pueden leer insumos" ON erp_insumos;
CREATE POLICY "Usuarios autenticados pueden leer insumos" ON erp_insumos
  FOR SELECT TO authenticated USING (true);

DROP POLICY IF EXISTS "Usuario puede insertar insumos" ON erp_insumos;
CREATE POLICY "Usuario puede insertar insumos" ON erp_insumos
  FOR INSERT TO authenticated WITH CHECK (auth.uid() IS NOT NULL);

DROP POLICY IF EXISTS "Usuario creador o admin puede modificar insumo" ON erp_insumos;
CREATE POLICY "Usuario creador o admin puede modificar insumo" ON erp_insumos
  FOR UPDATE TO authenticated
  USING (created_by = auth.uid() OR auth.jwt() ->> 'rol' = 'Administrador')
  WITH CHECK (true);

DROP POLICY IF EXISTS "Usuario puede eliminar insumos" ON erp_insumos;
CREATE POLICY "Usuario puede eliminar insumos" ON erp_insumos
  FOR DELETE TO authenticated
  USING (created_by = auth.uid() OR auth.jwt() ->> 'rol' = 'Administrador');

-- erp_sub_renglones - Políticas
DROP POLICY IF EXISTS "Usuarios autenticados pueden leer sub_renglones" ON erp_sub_renglones;
CREATE POLICY "Usuarios autenticados pueden leer sub_renglones" ON erp_sub_renglones
  FOR SELECT TO authenticated USING (true);

DROP POLICY IF EXISTS "Usuario puede insertar sub_renglones" ON erp_sub_renglones;
CREATE POLICY "Usuario puede insertar sub_renglones" ON erp_sub_renglones
  FOR INSERT TO authenticated WITH CHECK (auth.uid() IS NOT NULL);

DROP POLICY IF EXISTS "Usuario creador o admin puede modificar sub_renglon" ON erp_sub_renglones;
CREATE POLICY "Usuario creador o admin puede modificar sub_renglon" ON erp_sub_renglones
  FOR UPDATE TO authenticated
  USING (created_by = auth.uid() OR auth.jwt() ->> 'rol' = 'Administrador')
  WITH CHECK (true);

DROP POLICY IF EXISTS "Usuario puede eliminar sub_renglones" ON erp_sub_renglones;
CREATE POLICY "Usuario puede eliminar sub_renglones" ON erp_sub_renglones
  FOR DELETE TO authenticated
  USING (created_by = auth.uid() OR auth.jwt() ->> 'rol' = 'Administrador');
...
DROP TRIGGER IF EXISTS trigger_erp_renglones_updated_at ON erp_renglones;
DROP FUNCTION IF EXISTS update_erp_renglones_updated_at();
...
DROP TRIGGER IF EXISTS trigger_erp_insumos_updated_at ON erp_insumos;
DROP FUNCTION IF EXISTS update_erp_insumos_updated_at();
...
DROP TRIGGER IF EXISTS trigger_erp_sub_renglones_updated_at ON erp_sub_renglones;
DROP FUNCTION IF EXISTS update_erp_sub_renglones_updated_at();
