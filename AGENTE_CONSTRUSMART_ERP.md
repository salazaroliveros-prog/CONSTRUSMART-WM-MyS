...
```
costoPorHoraHombre()           → M-05: Costo MO por proyecto
empleadosDisponibles()         → M-08: Filtra empleados sin proyecto
avanceFinancieroCalculado()    → F-04: Derivado de movimientos
getPresupuestoByProyecto()     → Busca presupuesto vinculado
verificarStockCritico()        → Notificación si stock < mínimo
...
- **Hitos** — ✅ NUEVO - Timeline de milestones con detección de vencidos
- **Riesgos** | ✅ NUEVO - Matriz de calor 5×5, mitigation tracking

### Finanzas
- **Financiero** — Flujo de caja real/proyectado, gastos por categoría, centros de costo
- **CxC** | ✅ NUEVO - Cuentas por cobrar con vencimientos
- **CxP** | ✅ NUEVO - Cuentas por pagar con vencimientos
- **Impuestos** — Cálculo y gestión tributaria
- **Comercial/Fin** — Ventas, anticipos, cajas chicas

### Bodega
- **Bodega** — Inventario, proveedores, movimientos, cuadros comparativos
...
### Admin
- **Admin Sistema** | Centros de costo, auditoría
- **CRM** | Gestión de clientes
- **Notificaciones** | Centro de notificaciones

### Herramientas
- **Visor BIM** | Visor 3D IFC
- **Exportar** | PDF/CSV/JSON con reportes programados
...
- Sanitización XSS: sanitizarTexto() + sanitizarObjeto()
- CSRF tokens con comparación timing-safe
- Input validation con Zod schemas
- Sanitización en exports PDF/CSV
...
### F-01 a F-06 (Funcionalidad alta prioridad):
...
- F-06: Campo predecesores ya existía (M-03)

---

## 📐 REORGANIZACIÓN DEL MENÚ

### Menú actual: 32 items
### Menú propuesto: 8 grupos
