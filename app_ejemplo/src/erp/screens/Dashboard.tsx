      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mb-4">
        <div className="lg:col-span-2 bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
          <div className="flex items-center justify-between mb-2">
            <h3 className="font-bold text-slate-700 text-sm flex items-center gap-2"><Activity className="w-4 h-4 text-orange-500" /> Curva S Consolidada</h3>
        ...
        <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex flex-col">
            <h3 className="font-bold text-slate-700 text-sm mb-2">Ingresos vs Gastos</h3>
